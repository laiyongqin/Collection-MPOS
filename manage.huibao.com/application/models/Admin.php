...
class AdminModel extends BaseModel {
    ...
    public function getList($where=array(), $pagination=array()) {
        $data = $this->_setWhereSQL($where)
                    ...
                    ->_db->select('a_id,a_username,a_realname,a_phone,a_status,a_addtime,a_login_time')
                    ->from($this->_table)
    ...
    public function getInfo($id) {
        return $this->_db->select('a_id,a_username,a_realname,a_phone')->from($this->_table)->where($this->_primary_key, $id)->fetchOne();
    }
